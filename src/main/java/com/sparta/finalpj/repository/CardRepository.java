...
public interface CardRepository extends JpaRepository<Card, Long> {
    ...
    @Query(value = "select * from card where member_id = :member_id and card_name like %:keyword% or company like %:keyword% or department like %:keyword% or phone_num like %:keyword% or position like %:keyword% order by created_at", nativeQuery = true)
